...
*Verbatim mirror of `docs/validation_findings.md` as of the manuscript build. Append-only record of every divergence detected during the multi-pillar validation campaign (Pillars A–D, the post-campaign E efficiency audit, and the post-V1 reference-tool harnesses) with F3 classification and closure pointers.*
