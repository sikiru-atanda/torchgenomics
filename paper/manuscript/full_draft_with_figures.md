...
![**Figure 5.** Polyploid pipeline: (A) dosage-call recovery at k = 4, (B) PolyOrigin F1 phasing state path, (C) GWASpoly potato F1 round-trip scaffold, (D) arbitrary-ploidy live demo recovering the planted causal SNP at k ∈ {4, 6, 8}.](paper/reproducibility/output/png_300/F5.png){width=6.5in}
