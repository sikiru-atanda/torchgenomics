...
#   3. run_torchgwas.py: TorchGWAS OCFLMM on the same replicates.
...
#       torchgwas_results.tsv
#       torchgwas_summary.json
#   results/
#       summary.tsv
#       agreement.json
#       manifest.sha256
...
# --- Stage 3: TorchGWAS OCFLMM --------------------------------------------
echo "[ocf run] stage 3/4: TorchGWAS OCFLMM"
...
python3 "${HERE}/compare.py" \
    ...
    --torchgwas "${OUT}/torchgwas_results.tsv" \
    --torchgwas-summary "${OUT}/torchgwas_summary.json" \
