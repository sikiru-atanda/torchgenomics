...
def _gabriel_native_enabled() -> bool:
    ...
    return HAS_NATIVE_GABRIEL and not os.environ.get("TORCHGWAS_DISABLE_NATIVE")


def _spine_native_enabled() -> bool:
    """Whether the native C++ spine accelerator should be used."""
    return HAS_NATIVE_SPINE and not os.environ.get("TORCHGWAS_DISABLE_NATIVE")
...
def detect_blocks_gabriel(
    ...
    *,
    ...
    # extension is missing or TORCHGWAS_DISABLE_NATIVE=1 is set.
