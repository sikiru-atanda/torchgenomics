...
def _big_ld_native_enabled() -> bool:
    ...
    return HAS_NATIVE_BIG_LD and not os.environ.get("TORCHGWAS_DISABLE_NATIVE")


def _dp_optimize_native_enabled() -> bool:
    """Whether the native C++ DP-optimize accelerator should be used."""
    return HAS_NATIVE_DP_OPTIMIZE and not os.environ.get("TORCHGWAS_DISABLE_NATIVE")


def _cc_graph_native_enabled() -> bool:
    """Whether the native C++ cc-graph accelerator should be used."""
    return HAS_NATIVE_CC_GRAPH and not os.environ.get("TORCHGWAS_DISABLE_NATIVE")
...
def detect_blocks_big_ld(
    ...
    *,
    ...
    for chrom in chr_set:
        ...
        # TORCHGWAS_DISABLE_NATIVE=1 is set.
...
def detect_blocks_cc_graph(
    ...
    *,
    ...
    for chrom in chr_set:
        ...
        # missing or TORCHGWAS_DISABLE_NATIVE=1 is set.
