...
six novelty methods that exploit TorchGWAS-specific infrastructure
...
- :func:`cauchy_combined`   — wraps :func:`torchgwas.stats.cauchy.cauchy_combination`.
- :func:`stouffer_combined` — wraps the Stouffer-Z internals of
                              :func:`torchgwas.postgwas.meta_sample_size`.
...
class CombinedGeneResult:
    ...
    p_gwas : float
        ...
        via :func:`torchgwas.postgwas._enrichment.snp_to_gene`). NaN if
...
def cauchy_combined(
    ...
    """Wrapper around :func:`torchgwas.stats.cauchy.cauchy_combination`.
...
def gwas_twas_conditional(
    ...
    p_gwas_conditional : float — GWAS p conditioned on the TWAS lead
        SNP via :class:`torchgwas.models.conditional_lmm.ConditionalLMM`.
...
def combine_gwas_twas(
    ...
    *,
    ...
    :func:`torchgwas.postgwas._enrichment.snp_to_gene` (MAGMA-style
