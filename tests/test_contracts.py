...
class TestIOProtocols:
    ...
    def test_import_genotype_reader(self):
        from torchgenomics.io.base import GenotypeReader
    ...
    def test_import_preflight_report(self):
        ...
        from torchgenomics.io.validate import PreflightReport
        assert dataclasses.is_dataclass(PreflightReport)

    def test_import_alignment_manifest(self):
        import dataclasses

        from torchgenomics.io.phenotype import AlignmentManifest
...
class TestPreprocessContracts:
    ...
    def test_import_qc_config(self):
        ...
        from torchgenomics.preprocess.qc import QCFilterConfig, VariantQCStats
    ...
    def test_import_imputation_result(self):
        ...
        from torchgenomics.preprocess.impute_external import ImputationResult
        assert dataclasses.is_dataclass(ImputationResult)

    def test_import_gene_action_models(self):
        from torchgenomics.preprocess.polyploid import GENE_ACTION_MODELS
...
class TestOptimContracts:
    ...
    def test_import_optimizer_mode(self):
        from torchgenomics.optim.controller import OptimizerMode
