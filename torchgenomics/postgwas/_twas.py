...
def twas_observed_expression(
    ...
    *,
    ...
    The OLS path reuses ``torchgenomics.models.glm.GLM``; the LMM path reuses
    ``torchgenomics.models.single_trait_lmm.SingleTraitLMM``. Both already
    ...
    expression : Tensor
        ...
        See ``torchgenomics.preprocess.expression`` for helper transforms if
        needed.
    phenotype : Tensor
    ...
    if kinship is None:
        ...
        # PLINK convention. ``torchgenomics.models.glm.GLM`` uses the null-only
