...
def mr_egger(exposure: SumStats, outcome: SumStats) -> MRResult:
    ...
    # small-sample WLS inference). The previous TorchGenomics implementation
...
def mr_presso(
    ...
    * ``null="permutation"`` (legacy TorchGenomics behavior). Permute
    ...
    null : {"parametric", "permutation"}
        ...
        original TorchGenomics behavior. Default is ``"parametric"``.
...
def _presso_null_permutation(
    ...
    *,
    ...
    """Legacy TorchGenomics permutation null (pre-2026-04-30 behavior).
